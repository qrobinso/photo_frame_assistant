...
Registered in server.py alongside integration_routes.
Access app.plugin_runner via current_app.plugin_runner.
"""
...
from plugins.config_crypto import SENTINEL, decrypt_secrets, encrypt_secrets, mask_for_api
...
def install_playwright():
    ...
    def _do_install():
        ...
        try:
            ...
            # Invalidate cache
            from plugins.plugin_runner import _playwright_cache
